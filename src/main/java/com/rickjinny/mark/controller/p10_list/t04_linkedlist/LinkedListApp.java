package com.rickjinny.mark.controller.p10_list.t04_linkedlist;
...
public class LinkedListApp {
     ...
     * LinkedList 访问
     */
    private static void linkListGet(int elementCount, int loopCount) {
    ...
    private static void arrayListGet(int elementCount, int loopCount) {
        ArrayList<Integer> list = IntStream.rangeClosed(1, elementCount)
                                        .boxed()
    ...
    public static void main(String[] args) {
        ...
        linkListGet(elementCount, loopCount);
        stopWatch.stop();
