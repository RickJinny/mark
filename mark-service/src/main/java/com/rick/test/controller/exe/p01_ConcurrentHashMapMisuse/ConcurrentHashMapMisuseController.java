package com.rick.test.controller.exe.p01_ConcurrentHashMapMisuse;
...
public class ConcurrentHashMapMisuseController {
    ...
    public String wrong() throws InterruptedException {
        ...
        // 使用线程池并发处理逻辑
        forkJoinPool.execute(() -> IntStream.rangeClosed(1, 10).forEach(i -> {
            // 查询还需要补充多少个元素
    ...
    public String right() throws InterruptedException {
        ...
        forkJoinPool.execute(() -> IntStream.rangeClosed(1, 10).parallel().forEach(i -> {
            // 下面的这段复合逻辑，需要锁一下这个 ConcurrentHashMap
